...
vector<Member *> MemberController::searchForSupporters(Member *currentMember)
{
    ...
    cout << "| " << std::left << std::setw(16) << "Credit Point"
         << " | " << std::setw(12) << currentMember->getCreditPoint() << " |\n";
    cout << "| " << std::left << std::setw(16) << "Host Rating"
         << " | " << std::setw(12) << currentMember->getHostRating() << " |\n";
    cout << "| " << std::left << std::setw(16) << "City"
         << " | " << std::setw(12) << currentMember->getAvailableCity() << " |\n";
    cout << "-----------------------------------\n\n";
